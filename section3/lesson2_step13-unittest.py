...
class TestLink(unittest.TestCase):
    def test_link1(self):
        ...
        self.assertEqual(fill(link1), "Congratulations! You have successfully registered!", "Error somewhere")

    def test_link2(self):
        link2 = "http://suninjuly.github.io/registration2.html"
        self.assertEqual(fill(link2), "Congratulations! You have successfully registered!", "NoSuchElementException")
